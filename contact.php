                            ...
                            <div class="row mil-aic mil-jcb mil-no-g">
                                ...
                                <div class="col-lg-6 mil-992-gone">
                                    <div class="mil-text-pad">
                                        <p class="mil-text-sm mil-up">By clicking the send button, you agree to the <br><a href="contact.php" class="mil-text-link mil-a2 mil-c-gone">rules for processing personal data</a>.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
