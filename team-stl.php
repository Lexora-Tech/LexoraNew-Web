                                    ...
                                    <div class="mil-menu-part mil-inner-scroll" id="swupMenu">
                                        <ul class="mil-main-menu mil-c-gone">
                                            ...
                                            <li class="mil-has-children">
                                                <a href="#.">Pages</a>
                                                <ul>
                                                    <li class="mil-current"><a href="team-stl.php">Team</a></li>
                            ...
                            <div class="row mil-aic">
                                <div class="col-md-6 col-lg-4">
                                    <div class="mil-team-card mil-stl mil-mb30 mil-768-mb-15 mil-up">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <div class="mil-descr">
                                                <h4 class="mil-head4 mil-m1 mil-mb20">Tom</h4>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="mil-team-card mil-stl mil-mb30 mil-768-mb-15 mil-up">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <div class="mil-descr">
                                                <h4 class="mil-head4 mil-m1 mil-mb20">Olivia</h4>
                                                <ul class="mil-social mil-mb20 mil-c-gone">
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="mil-team-card mil-stl mil-mb30 mil-768-mb-15 mil-up">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <div class="mil-descr">
                                                <h4 class="mil-head4 mil-m1 mil-mb20">Brian</h4>
                                                <ul class="mil-social mil-mb20 mil-c-gone">
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="mil-team-card mil-stl mil-mb30 mil-768-mb-15 mil-up">
                                        <div class="mil-hover-frame">
                                            <img src="img/team/13.jpg" alt="team member" class="mil-scale-img" data-value-1="1.20" data-value-2="1">
                                        </div>
                                        <div class="mil-hover-overlay">
                                            <div class="mil-descr">
                                                <h4 class="mil-head4 mil-m1 mil-mb20">Colin</h4>
                                                <ul class="mil-social mil-mb20 mil-c-gone">
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                ...
                                                <p class="mil-stylized mil-a1">Motion Designer</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="mil-team-card mil-stl mil-mb30 mil-768-mb-15 mil-up">
                                        <div class="mil-hover-frame">
                                            <img src="img/team/14.jpg" alt="team member" class="mil-scale-img" data-value-1="1.20" data-value-2="1">
                                        </div>
                                        <div class="mil-hover-overlay">
                                            <div class="mil-descr">
                                                ...
                                                <p class="mil-stylized mil-a1">CEO Founder</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="mil-team-card mil-stl mil-mb30 mil-768-mb-15 mil-up">
                                        <div class="mil-hover-frame">
                                            <img src="img/team/15.jpg" alt="team member" class="mil-scale-img" data-value-1="1.20" data-value-2="1">
                                        </div>
                                        <div class="mil-hover-overlay">
                                            <div class="mil-descr">
                                                <h4 class="mil-head4 mil-m1 mil-mb20">Erica</h4>
                                                <ul class="mil-social mil-mb20 mil-c-gone">
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="mil-team-card mil-stl mil-mb30 mil-768-mb-15 mil-up">
                                        <div class="mil-hover-frame">
                                            <img src="img/team/16.jpg" alt="team member" class="mil-scale-img" data-value-1="1.20" data-value-2="1">
                                        </div>
                                        <div class="mil-hover-overlay">
                                            <div class="mil-descr">
                                                <h4 class="mil-head4 mil-m1 mil-mb20">Spunky</h4>
                                                <ul class="mil-social mil-mb20 mil-c-gone">
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                    <li><a href="#." target="_blank" data-no-swup><i class="far fa-circle"></i></a></li>
                                                </ul>
                                                <p class="mil-stylized mil-a1">Paw giver</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <div class="mil-half-container mil-stl mil-up">
                            <div class="mil-text-box mil-g-m4 mil-p-160-160">
                                ...
                                <h2 class="mil-display3 mil-rubber mil-mb60 mil-m1 mil-up">Let’s <span class="mil-a1">make</span><br>an <span class="mil-a1">impact</span><br>together.</h2>
                                ...
                                <div class="mil-up"><a href="contact-stl.php" class="mil-btn mil-btn-border mil-m1 mil-c-gone">Get in touch</a></div>
                            </div>
