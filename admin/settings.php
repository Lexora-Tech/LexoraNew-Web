            ...
            <div class="content-wrapper">
                ...
                <div class="settings-container">
                    ...
                    <div class="settings-nav">
                        <div class="settings-tab active" onclick="openTab(event, 'profile')"><i class="fas fa-user"></i>
                            My Profile</div>
                        <div class="settings-tab" onclick="openTab(event, 'security')"><i class="fas fa-shield-alt"></i>
                            Security</div>
                        <div class="settings-tab" onclick="openTab(event, 'notifications')"><i class="fas fa-bell"></i>
                            Notifications</div>
                        <div class="settings-tab" onclick="openTab(event, 'system')"><i class="fas fa-server"></i>
                            System</div>
                    </div>
                    ...
                    <div id="profile" class="settings-panel active">
                        ...
                        <div class="profile-header-content">
                            ...
                            <div class="profile-meta">
                                ...
                                <span><i class="fas fa-briefcase"></i> Administrator <span class="role-badge">Super
                                        Admin</span></span>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <form method="POST">
                                ...
                                <div class="form-grid">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" class="form-input"
                                            value="<?php echo $_SESSION['admin']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div style="text-align: right; margin-top: 20px;">
                                    <button type="submit" name="update_profile" class="btn-primary">Save
                                        Changes</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div id="notifications" class="settings-panel">
                        ...
                        <div class="panel-body">
                            <div class="section-title" style="border:none; padding:0; margin-bottom:10px;">Email Alerts
                            </div>
                            ...
                            <div class="section-title" style="border:none; padding:0; margin:30px 0 10px;">System Alerts
                            </div>
