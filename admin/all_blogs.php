                ...
                <div class="table-container">
                    ...
                    <div class="toolbar">
                        <form class="search-filter" method="GET" action="">
                            ...
                            <input type="text" name="search" placeholder="Search blog titles..."
                                ...
                                <tr id="row-<?= $row['id']?>">
                                    <td>
                                        <div class="blog-info">
                                            <img src="../uploads/<?= htmlspecialchars($row['cover_image'])?>"
                                                class="blog-thumb" alt="thumb">
                                            <div class="blog-text">
                                                <span class="blog-title-text">
                                                    <?= htmlspecialchars($row['title'])?>
                                                </span>
                                                <span class="blog-id">ID: #
                                                    <?= $row['id']?>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="action-btns">
                                            ...
                                            <button type="button" class="act-btn delete-trigger"
...
?>
                    ...
                    <div class="table-footer">
                        ...
                        <div class="pagination">
                            ...
                            <?php if ($page > 1): ?>
                            <a href="<?= get_page_link($page - 1, $search_term)?>" class="page-link"><i
...
for ($i = $start; $i <= $end; $i++):
?>
                            <a href="<?= get_page_link($i, $search_term)?>"
