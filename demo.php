                    ...
                    <div class="mil-menu-section mil-inner-scroll" id="swupMenu" style="height: 100%">
                        <ul class="mil-main-menu mil-c-gone" style="height: 100%; padding-bottom: 60px">
                            ...
                            <li class="mil-has-children">
                                <a href="#.">Home type</a>
                                <ul>
                                    <li><a href="index.php" target="_blank" data-no-swup>Corporate</a></li>
                            ...
                            <li class="mil-has-children">
                                <a href="#.">Portfolio</a>
                                <ul>
                                    <li><a href="portfolio-1-frl.php" target="_blank" data-no-swup>Grid type 1</a></li>
                                    <li><a href="portfolio-2-frl.php" target="_blank" data-no-swup>Grid type 2</a></li>
                                    <li><a href="portfolio-3-frl.php" target="_blank" data-no-swup>Grid type 3</a></li>
                                </ul>
                            </li>
                            <li class="mil-has-children">
                                <a href="#.">Pages</a>
                                <ul>
                                    <li><a href="team-frl.php" target="_blank" data-no-swup>Team</a></li>
                                    <li><a href="contact-frl.php" target="_blank" data-no-swup>Contact</a></li>
                                    <li><a href="services-frl.php" target="_blank" data-no-swup>Services</a></li>
                                    <li><a href="service-frl.php" target="_blank" data-no-swup>Service single</a></li>
                                    <li><a href="blog-frl.php" target="_blank" data-no-swup>Blog</a></li>
                                    <li><a href="publication-frl.php" target="_blank" data-no-swup>Publication</a></li>
                                    <li><a href="404-frl.php" target="_blank" data-no-swup>404</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="container mil-hero-main mil-relative mil-aic">
                            <div class="mil-hero-text mil-scale-img" data-value-1="1.3" data-value-2="0.95" style="padding-top: 60px">
                                ...
                                <div class="mil-word-frame mil-mb30">
                                    <h1 class="mil-display1 mil-rubber">LexoraTech</h1>
                    ...
                    <div id="scroll">
                        <div class="container">
                            <div class="row mil-aie mil-mb30">
                                ...
                                <div class="col-md-5">
                                    <p class="mil-stylized mil-m1 mil-tar mil-768-tal mil-mb60 mil-up"><a href="index.php" class="mil-arrow-link mil-c-gone" data-no-swup target="_blank">View demo</a></p>
                                </div>
                            </div>
