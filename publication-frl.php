                        ...
                        <ul class="mil-main-menu mil-c-gone">
                            ...
                            <li class="mil-has-children">
                                ...
                                <ul>
                                    ...
                                    <li class="mil-current"><a href="publication-frl.php">Publication</a></li>
                            ...
                            <div class="row mil-jcc mil-aic">
                                <div class="col-lg-12 mil-mb160">
                                    <div class="mil-project-img mil-land mil-up">
                                        <img src="img/blog/6.jpg" alt="project" class="mil-scale-img" data-value-1="1.15" data-value-2="1">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    ...
                                    <div class="row mil-mb60">
                                        <div class="col-lg-6">
                                            <div class="mil-project-img mil-land mil-up mil-mb30">
                                                <img src="img/blog/1.jpg" alt="project" class="mil-scale-img" data-value-1="1.15" data-value-2="1">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mil-project-img mil-land mil-up mil-mb30">
                                                <img src="img/blog/4.jpg" alt="project" class="mil-scale-img" data-value-1="1.15" data-value-2="1">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="mil-p-0-160">
                        <div class="container">
                            <div class="row mil-aie mil-mb30">
                                ...
                                <div class="col-md-6">
                                    <p class="mil-stylized mil-m1 mil-tar mil-768-tal mil-mb60 mil-up"><a href="blog-frl.php" class="mil-arrow-link mil-c-gone">View all publications</a></p>
                                </div>
                            </div>
                                ...
                                <div class="swiper-wrapper mil-c-swipe mil-c-light">
                                    <div class="swiper-slide">
                                        <div class="mil-blog-card">
                                            ...
                                            <a href="publication-frl.php" class="mil-descr mil-c-gone">
                                                <div class="mil-text-frame">
