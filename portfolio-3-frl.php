                        ...
                        <ul class="mil-main-menu mil-c-gone">
                            ...
                            <li class="mil-has-children">
                                ...
                                <ul>
                                    ...
                                    <li class="mil-current"><a href="portfolio-3-frl.php">Grid type 3</a></li>
                                </ul>
                            </li>
                            <li class="mil-has-children">
                                <a href="#.">Pages</a>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mil-work-card mil-mb30">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <a href="project-5-frl.php" class="mil-descr">
                                                <div class="mil-text-frame">
                                    ...
                                    <div class="mil-work-card mil-mb30">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <a href="project-6-frl.php" class="mil-descr">
                                                <div class="mil-text-frame">
                                    ...
                                    <div class="mil-work-card mil-mb30">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <a href="project-2-frl.php" class="mil-descr">
                                                <div class="mil-text-frame">
                                ...
                                <div class="col-md-3">
                                    <div class="mil-work-card mil-mb30">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <a href="project-4-frl.php" class="mil-descr">
                                                <div class="mil-text-frame">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="mil-work-card mil-mb30">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <a href="project-1-frl.php" class="mil-descr">
                                                <div class="mil-text-frame">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="mil-work-card mil-mb30">
                                        ...
                                        <div class="mil-hover-overlay">
                                            <a href="project-3-frl.php" class="mil-descr">
                                                <div class="mil-text-frame">
                    ...
                    <div class="mil-p-0-160">
                        <div class="container mil-relative">
                            ...
                            <div class="mil-text-with-button mil-mb60">
                                ...
                                <span class="mil-up"><a href="contact-frl.php" class="mil-btn mil-a2 mil-c-gone">Write message</a></span>
                            </div>
                        </div>
